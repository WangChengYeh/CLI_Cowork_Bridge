...
def update_gemini_binding(session, *, session_path: Optional[Path], session_id: Optional[str]) -> None:
...
def binding_change(session, *, session_path: Optional[Path], session_id: Optional[str]) -> Optional[GeminiBindingChange]:
