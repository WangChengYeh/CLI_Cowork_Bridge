...
class IMessageCorrelationStore:
    ...
    def bind_source_event(self, event: RoomEvent, *, correlation_id: str) -> IMessageCorrelationBinding | None:
    ...
    def load_binding(self, correlation_id: str) -> IMessageCorrelationBinding | None:
        bindings = self.store.read_transport_bindings()
